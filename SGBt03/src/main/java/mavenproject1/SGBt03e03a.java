...
public class SGBt03e03a {
//con una lectura de teclado adelantada (antes de entrar en el bucle)

    public static void main(String[] args) {
        Scanner teclado = new Scanner(System.in);
        double numero;
        try {
            System.out.println("Escribe un numero positivo(negativo para finalizar): ");
            ...
            while (numero >= 0) {
                ...
                System.out.println("\nEscribe otro numero positivo(negativo para finalizar): ");
                numero = teclado.nextDouble();
